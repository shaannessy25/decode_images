...
def decode_image(path_to_png):
    """
    This method will take an image as parameter, open the image with pillow,
    and then will seperate the image into a color channel. It will then create a new
    pillow image and upload with the original dimensions.
    """
